...
public class DemoHelper {
    ...
    public static void freeArtHook() {
        ...
        if (sdkInt >= 0 && sdkInt <= Integer.MAX_VALUE) {
            if (sdkInt >= 0 && sdkInt <= Integer.MAX_VALUE) {
                Bridge.hook(android.app.Activity.class, Proguard.class, Proguard2.class, "onCreate", "(Landroid/os/Bundle;)V", android.app.Activity.class, android.os.Bundle.class);
            }
        }
    }
}
